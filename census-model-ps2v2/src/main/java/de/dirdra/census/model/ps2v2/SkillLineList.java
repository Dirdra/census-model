...
/**
 * <p>Java-Klasse für skill_line_list complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="skill_line_list"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="skill_line" type="{}skill_line" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "skill_line_list", propOrder = {
    "skillLine"
})
public class SkillLineList {

    @XmlElement(name = "skill_line")
    protected List<SkillLine> skillLine;
    ...
    /**
     * Gets the value of the skillLine property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the skillLine property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSkillLine().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<SkillLine> getSkillLine() {
        if (skillLine == null) {
            skillLine = new ArrayList<SkillLine>();
        }
