...
/**
 * <p>Java-Klasse für effect_type_list complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="effect_type_list"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="effect_type" type="{}effect_type" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "effect_type_list", propOrder = {
    "effectType"
})
public class EffectTypeList {

    @XmlElement(name = "effect_type")
    protected List<EffectType> effectType;
     ...
     * 
     */
    public List<EffectType> getEffectType() {
        if (effectType == null) {
            effectType = new ArrayList<EffectType>();
        }
