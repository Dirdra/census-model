...
/**
 * <p>Java-Klasse für directive_tree_list complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="directive_tree_list"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="directive_tree" type="{}directive_tree" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "directive_tree_list", propOrder = {
    "directiveTree"
})
public class DirectiveTreeList {

    @XmlElement(name = "directive_tree", required = true)
    protected List<DirectiveTree> directiveTree;
    ...
    /**
     * Gets the value of the directiveTree property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the directiveTree property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDirectiveTree().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DirectiveTree> getDirectiveTree() {
        if (directiveTree == null) {
            directiveTree = new ArrayList<DirectiveTree>();
        }
