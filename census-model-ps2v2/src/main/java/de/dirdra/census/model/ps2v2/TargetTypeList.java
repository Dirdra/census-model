...
/**
 * <p>Java-Klasse für target_type_list complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="target_type_list"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="target_type" type="{}target_type" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "target_type_list", propOrder = {
    "targetType"
})
public class TargetTypeList {

    @XmlElement(name = "target_type")
    protected List<TargetType> targetType;
    ...
    public List<TargetType> getTargetType() {
        if (targetType == null) {
            targetType = new ArrayList<TargetType>();
        }
