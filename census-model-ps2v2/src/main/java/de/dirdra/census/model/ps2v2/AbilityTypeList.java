...
/**
 * <p>Java-Klasse für ability_type_list complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="ability_type_list"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="ability_type" type="{}ability_type" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "ability_type_list", propOrder = {
    "abilityType"
})
public class AbilityTypeList {

    @XmlElement(name = "ability_type", required = true)
    protected List<AbilityType> abilityType;
    ...
    /**
     * Gets the value of the abilityType property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the abilityType property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAbilityType().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<AbilityType> getAbilityType() {
        if (abilityType == null) {
            abilityType = new ArrayList<AbilityType>();
        }
