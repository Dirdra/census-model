...
/**
 * <p>Java-Klasse für character_name_list complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="character_name_list"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="character_name" type="{}character_name" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "character_name_list", propOrder = {
    "characterName"
})
public class CharacterNameList {

    @XmlElement(name = "character_name")
    protected List<CharacterName> characterName;
     ...
     * This is why there is not a <CODE>set</CODE> method for the characterName property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCharacterName().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CharacterName> getCharacterName() {
        if (characterName == null) {
            characterName = new ArrayList<CharacterName>();
        }
