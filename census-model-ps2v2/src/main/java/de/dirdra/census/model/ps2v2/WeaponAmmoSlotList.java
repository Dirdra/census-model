...
/**
 * <p>Java-Klasse für weapon_ammo_slot_list complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="weapon_ammo_slot_list"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="weapon_ammo_slot" type="{}weapon_ammo_slot" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "weapon_ammo_slot_list", propOrder = {
    "weaponAmmoSlot"
})
public class WeaponAmmoSlotList {

    @XmlElement(name = "weapon_ammo_slot")
    protected List<WeaponAmmoSlot> weaponAmmoSlot;
    ...
    /**
     * Gets the value of the weaponAmmoSlot property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the weaponAmmoSlot property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWeaponAmmoSlot().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<WeaponAmmoSlot> getWeaponAmmoSlot() {
        if (weaponAmmoSlot == null) {
            weaponAmmoSlot = new ArrayList<WeaponAmmoSlot>();
        }
        return this.weaponAmmoSlot;
    }
