...
/**
 * <p>Java-Klasse für reward_type_list complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="reward_type_list"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="reward_type" type="{}reward_type" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "reward_type_list", propOrder = {
    "rewardType"
})
public class RewardTypeList {

    @XmlElement(name = "reward_type")
    protected List<RewardType> rewardType;
     ...
     * This is why there is not a <CODE>set</CODE> method for the rewardType property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRewardType().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<RewardType> getRewardType() {
        if (rewardType == null) {
            rewardType = new ArrayList<RewardType>();
        }
