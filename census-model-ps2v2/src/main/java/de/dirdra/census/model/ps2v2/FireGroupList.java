...
/**
 * <p>Java-Klasse für fire_group_list complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="fire_group_list"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="fire_group" type="{}fire_group" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "fire_group_list", propOrder = {
    "fireGroup"
})
public class FireGroupList {

    @XmlElement(name = "fire_group")
    protected List<FireGroup> fireGroup;
    ...
    /**
     * Gets the value of the fireGroup property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the fireGroup property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFireGroup().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<FireGroup> getFireGroup() {
        if (fireGroup == null) {
            fireGroup = new ArrayList<FireGroup>();
        }
